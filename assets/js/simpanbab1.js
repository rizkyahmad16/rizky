const dbmenanya1 = db.ref('db_menanya1/').on('value', menanya1Success, handleError)
let pk1 = 0;
var counter = 0;
...
const dbmengkomunikasikan1 = db.ref('db_mengkomunikasikan1/').on('value', mengkomunikasikan1Success, handleError)
let pk2 = 0;
var counter2 = 0;
...
function createMenanya1(nama, nisn, sekolah, kelas, menanya1_1, jmenanya1_1, menanya1_2, jmenanya1_2, menanya1_3, jmenanya1_3, menanya1_4, jmenanya1_4, waktunya, hari) {
    var task = {
        id: counter,
        nama: nama,
        nisn: nisn,
...
function menanya1() {
    ...
    if (
        ...
        createMenanya1(nama, nisn, sekolah, kelas, menanya1_1.value, jmenanya1_1.value, menanya1_2.value, jmenanya1_2.value, menanya1_3.value, jmenanya1_3.value, menanya1_4.value, jmenanya1_4.value, waktunya, harinya);
...
function createMengkomunikasikan1(nama, nisn, sekolah, kelas, mengkomunikasikan1_1, mengkomunikasikan1_2, mengkomunikasikan1_3, waktunya, hari) {
    var task = {
        id: counter2,
        nama: nama,
        nisn: nisn,
...
function mengkomunikasikan1() {
    ...
    if (
        ...
        createMengkomunikasikan1(nama, nisn, sekolah, kelas, mengkomunikasikan1_1.value, mengkomunikasikan1_2.value, mengkomunikasikan1_3.value, waktunya, harinya);
